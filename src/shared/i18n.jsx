...
const I18N = {
  vi: {
    ...
    nav: { exercises: "Thư viện bài tập", students: "Theo dõi học sinh", stats: "Thống kê",
      ...
      dashboard: "Trang chủ", settings: "Cài đặt", tips: "Sổ tay lớp", exam: "Thi thử", exams: "Đề thi thử", oral: "Bài nói", results: "Kết quả thi", decks: "Flashcard",
  ...
  fr: {
    ...
    nav: { exercises: "Bibliothèque d'exercices", students: "Suivi des élèves", stats: "Statistiques",
      ...
      dashboard: "Accueil", settings: "Paramètres", tips: "Carnet", exam: "Examen blanc", exams: "Sujets d examen", oral: "Production orale", results: "Résultats", decks: "Flashcard",
  ...
  en: {
    ...
    nav: { exercises: "Exercise library", students: "Student tracking", stats: "Statistics",
      ...
      dashboard: "Home", settings: "Settings", tips: "Notebook", exam: "Mock exam", exams: "Mock exam papers", oral: "Speaking", results: "Exam results", decks: "Flashcard",

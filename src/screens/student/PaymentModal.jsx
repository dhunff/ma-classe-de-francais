...
export default function PaymentModal({ ex, student, config, onClose }) {
  const t = useT();
    ...
    <div className="mcf-float fixed inset-0 z-[9999] flex items-start justify-center overflow-y-auto bg-ink/50 p-4 sm:items-center"
      ...
      <div onClick={(e) => e.stopPropagation()}
        ...
        <div className="px-5 py-4">
          ...
          {/* Nói rõ đây là quy trình thủ công. Học sinh cần biết mình đang chờ
              một người, không phải chờ máy. */}
          <p className="flex items-start gap-2 rounded-md bg-surface2 px-3 py-2.5 text-sm leading-relaxed text-soft">

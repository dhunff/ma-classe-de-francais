...
const VI = {
  ...
  tour: { xp1_title: "Điểm kinh nghiệm (XP)", xp1_body: "Đây là ví XP của bạn. Lần đầu hoàn thành một bài, bạn nhận 10 XP cộng 1 XP cho mỗi điểm đạt được.", xp2_title: "Đổi XP lấy bài trả phí", xp2_body: "Một số bài nâng cao là bài trả phí. Nếu giáo viên cho phép đổi bằng XP, bạn có thể dùng XP của mình để mở khoá chúng thay vì trả tiền.", xp3_title: "Bắt đầu tích XP!", xp3_body: "Chọn một kỹ năng và hoàn thành bài đầu tiên để nhận những XP khởi đầu nhé. Chúc bạn học tốt!", pf1_title: "Hoàn thiện hồ sơ", pf1_body: "Chào mừng bạn đến với FRACILE! Hãy dành 1 phút điền đầy đủ thông tin để có trải nghiệm học tập tốt nhất.", pf2_title: "Tên định danh (username)", pf2_body: "Tạo một @username duy nhất cho riêng bạn. Giáo viên dùng tên này để tìm và nhận ra bạn.", pf3_title: "Lộ trình học tập", pf3_body: "Chọn trình độ hiện tại và mục tiêu DELF/DALF của bạn, để giáo viên nắm được bạn đang ở đâu và muốn đi tới đâu.", pf4_title: "Lưu thông tin", pf4_body: "Điền xong thì bấm lưu lại để bắt đầu hành trình chinh phục tiếng Pháp cùng FRACILE nhé!", fc1_title: "Lọc theo kỹ năng", fc1_body: "Phân loại các bộ thẻ theo từng kỹ năng Nghe, Đọc, Viết, Nói để tập trung ôn luyện hiệu quả hơn.", fc2_title: "Nội dung chuẩn xác", fc2_body: "Toàn bộ flashcard trên FRACILE đều do giáo viên trực tiếp biên soạn. Bấm vào một bộ để bắt đầu ôn tập ngay!", fc3_title: "Nắm rõ khối lượng", fc3_body: "Mỗi bộ hiển thị rõ số lượng thẻ. Ôn một ít mỗi ngày — lịch ôn sẽ đưa lại đúng những thẻ bạn sắp quên.", skip: "Bỏ qua", next: "Tiếp theo", back: "Quay lại", finish: "Hoàn thành", cal1_title: "Tự động đồng bộ hạn nộp", cal1_body: "Mọi bài tập giáo viên giao sẽ tự động xuất hiện tại đây, để bạn không bỏ lỡ hạn nộp nào.", cal2_title: "Chủ động lên lịch học", cal2_body: "Bạn có thể tự thêm các khung giờ tự học, ôn thi DELF hoặc nhắc nhở cá nhân để quản lý thời gian hiệu quả.", cal3_title: "Theo dõi tiến trình", cal3_body: "Dễ dàng chuyển đổi giữa các tuần để xem lại lịch sử học tập hoặc lên kế hoạch cho tương lai." },
  follow: { tab_today: "Hôm nay", tab_rank: "Xếp hạng XP", you: "bạn", rank_hint: "Theo dõi thêm bạn học để có bảng xếp hạng.", title: "Đang theo dõi", follow: "Theo dõi", unfollow: "Bỏ theo dõi", studied: "Đã học hôm nay", not_yet: "Chưa học", empty: "Theo dõi bạn học bằng @username để cùng giữ chuỗi ngày học.", error: "Không tải được danh sách — thử tải lại trang.", modal_title: "Theo dõi bạn học", modal_help: "Nhập @username của người bạn muốn theo dõi.", err_khong_thay: "Không tìm thấy @username này.", err_chinh_minh: "Bạn không thể tự theo dõi chính mình.", err_chua_dang_nhap: "Phiên đăng nhập đã hết hạn.", err_mang: "Không gửi được — kiểm tra kết nối." },
  xp: { topbar_title: "Điểm kinh nghiệm (XP)", balance: "Số dư XP", balance_hint: "XP có được khi hoàn thành bài lần đầu: 10 XP + 1 XP mỗi điểm.", unlock_btn: "Đổi {n} XP", confirm_title: "Đổi {n} XP để mở khóa bài tập này?", confirm_btn: "Xác nhận đổi", cancel: "Hủy", cost_ph: "Giá XP (tuỳ chọn)", err_khong_du_xp: "Bạn có {n} XP, cần {gia} XP.", err_khong_doi_duoc: "Bài này không đổi bằng XP được.", err_khong_co_ho_so: "Chưa tìm thấy hồ sơ của bạn.", err_chua_dang_nhap: "Phiên đăng nhập đã hết hạn.", err_mang: "Không đổi được — kiểm tra kết nối rồi thử lại." },
  notif: { title: "Thông báo", mark_all: "Đánh dấu đã đọc", empty_title: "Không có thông báo mới", empty_subtitle: "Bạn đã xem hết mọi thứ!", bell_unread: "Thông báo, {n} chưa đọc" },
  suivi: { tab_library: "Thư viện", tab_tracking: "Theo dõi học sinh", summary: "{n} lượt luyện tập · {hs} học sinh", tries: "{n} lần làm", tries_label: "Số lần làm", best: "Điểm cao nhất", last: "Lần gần nhất", skills: "Kỹ năng", deleted: "Bài đã bị xoá", empty_title: "Chưa có lượt luyện tập nào", empty_body: "Khi học sinh làm xong một bài trong thư viện, kết quả sẽ hiện ở đây.", note: "Luyện tập được chấm ngay: chỉ lưu điểm cao nhất, số lần làm và thời điểm — không lưu từng câu trả lời." },
  bd: {"save_failed":"Không lưu được bài.","edit_title":"Chỉnh sửa bài tập","new_title":"Bài tập mới","type_label":"Loại sử dụng","type_homework":"Bài tập về nhà","type_practice":"Luyện tập tự do","practice_note":"Bài này sẽ nằm trong Thư viện luyện tập, mọi học sinh đều làm được.","vocab_label":"Từ vựng (tuỳ chọn) — hiện trong menu « Luyện tập ▾ »","tips_label":"Giải thích / Mẹo (tuỳ chọn)","title_label":"Tiêu đề","instruction_label":"Đề bài / Hướng dẫn (tuỳ chọn)","level_label":"Trình độ","skills_label":"Kỹ năng (chọn nhiều)","deadline_label":"Hạn nộp (tuỳ chọn)","time_limit_label":"Thời gian làm bài (phút)","image_label":"Ảnh minh hoạ (tuỳ chọn)","remove_image":"Bỏ ảnh","audio_label":"Đường dẫn audio cho nghe hiểu (tuỳ chọn — URL mp3)","audio_hint":"Mẹo: tải mp3 lên Supabase Storage (bucket công khai) rồi dán URL công khai vào đây.","reading_label":"Văn bản đọc hiểu (tuỳ chọn) — học sinh sẽ thấy bố cục hai cột: văn bản | câu hỏi","reading_ph":"Dán bài báo hoặc văn bản cần đọc vào đây…","assignees_label":"Người nhận","assignees_all":"Giao cho toàn bộ học sinh","by_class":"Theo lớp","no_class":"Chưa có lớp nào — tạo ở mục Theo dõi học sinh.","by_student":"Theo từng học sinh","via_class":"Đã có trong lớp được chọn","duplicate":"Nhân bản","remove":"Xoá","q_prompt_ph":"Nội dung câu hỏi…","q_open_ph":"Đề bài (vd. câu cần dịch)…","correct":"Đáp án đúng","del_option":"Xoá phương án này","min_options":"Tối thiểu 2 phương án","qcm_hint":"2–6 phương án · tích đáp án đúng ở bên trái.","accepted_label":"Đáp án chấp nhận — ngăn cách bằng |","explain_label":"Giải thích khi làm sai (tuỳ chọn)","ordre_ph":"Gõ cả câu, vd. Je vais à l'école tous les jours.","gen_blocks":"Tách thành khối","merge_block":"Gộp với khối trước","del_block":"Xoá khối này","ordre_hint":"⇤ = gộp với khối trước (vd. « à » + « l'école »). Thứ tự trên là đáp án — học sinh sẽ nhận các khối đã xáo.","add_column":"+ Thêm đối tượng so sánh","add_criterion":"+ Thêm tiêu chí","criterion":"Tiêu chí","tableau_hint":"Tích CÓ hoặc KHÔNG ở mỗi ô để đặt đáp án.","justif_label":"Căn cứ cần trích (từ bài đọc)","model_label":"Đáp án mẫu / Gợi ý trả lời (tuỳ chọn)","t_qcm":"Trắc nghiệm","t_fill":"Điền vào chỗ trống","t_conj":"Chia động từ","t_open":"Tự luận","t_vf":"Đúng / Sai / ?","t_tableau":"Bảng CÓ/KHÔNG","t_ordre":"Sắp xếp câu","publish":"Xuất bản bài","cancel":"Huỷ","json_title":"Nhập JSON","json_load":"Chọn tệp .json","json_or":"hoặc dán nội dung vào ô trên","json_import":"Nhập","fill_hint":"Viết câu với ______ cho chỗ trống. Đáp án chấp nhận ngăn cách bằng | (vd. « vais|me rends »).","conj_hint":"Vd. đề: « Hier, nous (aller) ______ au cinéma. » Đáp án chấp nhận ngăn cách bằng | (vd. « sommes allés|sommes allées »).","sk_grammar":"Ngữ pháp","sk_vocab":"Từ vựng","sk_listening":"Nghe hiểu","sk_reading":"Đọc hiểu","sk_writing":"Viết","sk_speaking":"Nói","sk_translation":"Dịch","sk_communication":"Giao tiếp","sk_other":"Khác"},

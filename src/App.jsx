...
/* ============================================================
   ARCHITECTURE RULE : tout element flottant (Dropdown, Popover,
   Select, Tooltip, Modal) DOIT etre rendu via React Portal dans
   document.body avec zIndex global 9999. Ne jamais imbriquer un
   menu deroulant dans le DOM d'une Card ou d'un item de liste :
   animation/transform/filter/opacity y creent un stacking context

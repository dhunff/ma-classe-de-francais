-- 050 — chép hồ sơ mở rộng từ blob `s:mcf-profiles` sang cột
--
-- Cần 049 chạy trước (chín cột + tám ràng buộc).
--
-- ══════════════════════════════════════════════════════════════════════════
-- BLOB VẪN GIỮ NGUYÊN
-- ══════════════════════════════════════════════════════════════════════════
...
--
-- 052 sẽ gỡ quyền GHI của học sinh vào khoá này. Blob thành bản đông cứng chỉ

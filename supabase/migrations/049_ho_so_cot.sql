-- 049 — hồ sơ mở rộng thành CỘT trên public.profiles
--
-- CHỈ TẠO CẤU TRÚC. Chép dữ liệu ở 050, hàm ghi và quyền ở 051, siết policy
-- kv_store ở 052. Chạy đúng thứ tự đó.
--
-- ══════════════════════════════════════════════════════════════════════════
-- VÌ SAO
-- ══════════════════════════════════════════════════════════════════════════
...
-- ══════════════════════════════════════════════════════════════════════════
--
-- Mọi ràng buộc đều cho `null` qua. Bắt buộc: 050 chép dữ liệu cũ vào, và dữ
...
-- client là thứ người dùng chạy, còn RPC ở 051 nhận thẳng tham số — ai gọi
...
-- "049: chín cột hồ sơ mở rộng có mặt" sang xanh. Lệnh chạy xong không bao giờ
